...
const Icon = ({ n, sz = 16, c = "currentColor", style = {}, className }) => (_jsx("span", { className: className, style: { display: "inline-flex", alignItems: "center", justifyContent: "center", width: sz, height: sz, flexShrink: 0, color: c, lineHeight: 1, ...style }, dangerouslySetInnerHTML: {
